...
export class CompanyController {
  ...
  @Get('/read')
  async getCompanies(@CurrentUser() userInfo: CurrentUserDto) {
    return await this.companyService.getCompanies(userInfo);
  }
  ...
  async getCompany(
    ...
    return await this.companyService.getCompany(company, userInfo);
  }
